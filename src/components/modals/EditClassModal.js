...
import { X, BookOpen, Save, Loader2, Tag, User, Hash } from 'lucide-react';
...
export default function EditClassModal({ isOpen, onClose, classItem, onSuccess }) {
  ...
  // Configuración visual para Clases (Tema Esmeralda)
  const config = {
    icon: BookOpen,
    ...
    shadowFocus: 'rgba(16, 185, 129, 0.1)'
  };
  ...
  // --- Estilos y Manejadores (Consistentes) ---
  const inputStyle = {
    width: '100%',
    padding: '12px 16px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>
                {classItem ? 'Editar Clase' : 'Nueva Clase'}
              </h3>
              <p style={{ margin: '4px 0 0', fontSize: '0.9rem', color: '#64748b' }}>
                {classItem ? 'Modificar detalles de la asignatura' : 'Registrar una nueva asignatura'}
              </p>
            </div>
          </div>
                ...
                <div style={{ display: 'grid', gap: '24px' }}>
                    ...
                    <div>
                        ...
                        <div style={{ position: 'relative' }}>
                            <BookOpen size={18} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }} />
                            <input 
                                type="text" 
                                name="nombre_clase" 
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input 
                                    ...
                                    style={{...inputStyle, paddingLeft: '42px', letterSpacing: '0.5px'}} 
                                    onFocus={focusHandler} 
                                    onBlur={blurHandler} 
                                />
                            </div>
