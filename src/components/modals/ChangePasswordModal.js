...
export default function ChangePasswordModal({ isOpen, onClose }) {
  ...
  // Configuración visual (Tema Índigo/Seguridad)
  const config = {
    color: '#6366f1', // Indigo
  ...
  const validate = () => {
    ...
    if (!formData.confirmPassword) newErrors.confirmPassword = 'Confirma tu nueva contraseña';
    else if (formData.newPassword !== formData.confirmPassword) newErrors.confirmPassword = 'Las contraseñas no coinciden';
    if (formData.currentPassword && formData.currentPassword === formData.newPassword) newErrors.newPassword = 'La nueva contraseña debe ser diferente';
  ...
  const inputStyle = {
    width: '100%',
    padding: '12px 45px 12px 42px', // Padding para iconos izq/der
  ...
  return (
    <div className="modal-overlay show" onClick={handleClose} style={{
        zIndex: 9999,
            ...
            <form onSubmit={handleSubmit}>
                <div style={{ display: 'grid', gap: '20px' }}>
                    ...
                    <div>
                        ...
                        {errors.currentPassword && <span style={{ display: 'block', color: '#ef4444', fontSize: '0.85rem', marginTop: '6px', fontWeight: 500 }}>{errors.currentPassword}</span>}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.newPassword && <span style={{ display: 'block', color: '#ef4444', fontSize: '0.85rem', marginTop: '6px', fontWeight: 500 }}>{errors.newPassword}</span>}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.confirmPassword && <span style={{ display: 'block', color: '#ef4444', fontSize: '0.85rem', marginTop: '6px', fontWeight: 500 }}>{errors.confirmPassword}</span>}
                    </div>

                    {/* Info de seguridad */}
                    <div style={{
                        background: '#f0f9ff', borderRadius: '12px', padding: '16px',
                        border: '1px dashed #bae6fd', display: 'flex', gap: '12px', alignItems: 'start'
                    }}>
                        <ShieldCheck size={20} color="#0284c7" style={{ marginTop: '2px', flexShrink: 0 }} />
                        <div>
                            <h4 style={{ margin: '0 0 6px', fontSize: '0.9rem', color: '#075985', fontWeight: 700 }}>Seguridad de la cuenta</h4>
                            <ul style={{ margin: 0, paddingLeft: '16px', color: '#334155', fontSize: '0.85rem', lineHeight: '1.5' }}>
